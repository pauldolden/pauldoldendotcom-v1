...
export type FetchPostsDataQuery = { allMdx: { edges: Array<{ node: (
        Pick<Mdx, 'slug' | 'body' | 'timeToRead'>
        & { frontmatter?: Maybe<(
          Pick<MdxFrontmatter, 'title' | 'category' | 'date' | 'id' | 'summary'>
...
export type PostQueryQuery = { mdx?: Maybe<(
    Pick<Mdx, 'id' | 'body'>
