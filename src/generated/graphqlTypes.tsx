...
export enum FileFieldsEnum {
  ...
  ChildrenMdxFrontmatterSummary = 'childrenMdx___frontmatter___summary',
  ...
  ChildMdxFrontmatterSummary = 'childMdx___frontmatter___summary',
...
export enum SitePageFieldsEnum {
  ...
  PluginCreatorPluginOptionsUri = 'pluginCreator___pluginOptions___uri',
...
export enum SitePluginFieldsEnum {
  ...
  PluginOptionsUri = 'pluginOptions___uri',
...
export type FetchPostsDataQueryVariables = Exact<{ [key: string]: never }>;

export type FetchPostsDataQuery = { __typename?: 'Query' } & {
  allMdx: { __typename?: 'MdxConnection' } & {
    edges: Array<
      { __typename?: 'MdxEdge' } & {
        node: { __typename?: 'Mdx' } & Pick<
          Mdx,
...
export const FetchPostsDataDocument = gql`
...
/**
 * __useFetchPostsDataQuery__
 *
 * To run a query within a React component, call `useFetchPostsDataQuery` and pass it any options that fit your needs.
 * When your component renders, `useFetchPostsDataQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useFetchPostsDataQuery({
 *   variables: {
 *   },
 * });
 */
export function useFetchPostsDataQuery(
  baseOptions?: Apollo.QueryHookOptions<
    FetchPostsDataQuery,
    FetchPostsDataQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<FetchPostsDataQuery, FetchPostsDataQueryVariables>(
    FetchPostsDataDocument,
    options
  );
}
export function useFetchPostsDataLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<FetchPostsDataQuery, FetchPostsDataQueryVariables>(
    FetchPostsDataDocument,
    options
  );
}
export type FetchPostsDataQueryHookResult = ReturnType<
  typeof useFetchPostsDataQuery
>;
export type FetchPostsDataLazyQueryHookResult = ReturnType<
  typeof useFetchPostsDataLazyQuery
>;
export type FetchPostsDataQueryResult = Apollo.QueryResult<
  FetchPostsDataQuery,
  FetchPostsDataQueryVariables
>;
