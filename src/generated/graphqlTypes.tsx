...
export type FetchPostsDataQuery = (
  { __typename?: 'Query' }
  & { allMdx: (
    { __typename?: 'MdxConnection' }
    & { edges: Array<(
      ...
      & { node: (
        { __typename?: 'Mdx' }
        & Pick<Mdx, 'slug' | 'timeToRead'>
        & { frontmatter?: Maybe<(
          { __typename?: 'MdxFrontmatter' }
          & Pick<MdxFrontmatter, 'title' | 'category' | 'date' | 'id'>
        )> }
      ) }
    )> }
  ) }
 ...
 * });
 */
export function useFetchPostsDataQuery(baseOptions?: Apollo.QueryHookOptions<FetchPostsDataQuery, FetchPostsDataQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<FetchPostsDataQuery, FetchPostsDataQueryVariables>(FetchPostsDataDocument, options);
      }
export function useFetchPostsDataLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<FetchPostsDataQuery, FetchPostsDataQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<FetchPostsDataQuery, FetchPostsDataQueryVariables>(FetchPostsDataDocument, options);
        }
export type FetchPostsDataQueryHookResult = ReturnType<typeof useFetchPostsDataQuery>;
export type FetchPostsDataLazyQueryHookResult = ReturnType<typeof useFetchPostsDataLazyQuery>;
export type FetchPostsDataQueryResult = Apollo.QueryResult<FetchPostsDataQuery, FetchPostsDataQueryVariables>;
